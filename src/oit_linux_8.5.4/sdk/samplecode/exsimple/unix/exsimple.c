...
int main(int argc, char *argv[])
{
	...
	memset(&infoStatus, 0, sizeof(infoStatus));
...
ErrorExit:
	...
	if (Opts.dwExportStatusType == EXSTATUS_INFORMATION)
	{
		...
		if (!(infoStatus.bMissingMap ||
			...
			infoStatus.bIncorrectPageSize || // RNT for 27301827, 30/Jan/2018
			infoStatus.bIncorrectPageSize_lower || // RNT, bug 24675020, 25-APR-2018
		...
		else
		{
			...
			if (infoStatus.bIncorrectPageSize) // RNT for 27301827, 30/Jan/2018
				fprintf(stdout, " - The execution might not complete as PDF page size was larger than 200 in x 200 in, a constraint specified in the PDF Reference Guide.\n");

			if (infoStatus.bIncorrectPageSize_lower) // RNT, bug 24675020, 25-APR-2018
				fprintf(stdout, " - The execution might not complete as PDF page size was smaller than 3 units x 3 units, a constraint specified in the PDF Reference Guide.\n");
